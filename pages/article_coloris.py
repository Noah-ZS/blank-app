...
import pandas as pd
from common import load_articles, send_email_with_attachment, render_topbar

render_topbar("Version Production 5.2.1")

st.markdown('<div class="page-title font-serif" style="font-size:28px; margin-bottom:18px;">Article - Liste des Coloris / Taille</div>', unsafe_allow_html=True)
...
# --------------------------------------------------------
# REPORT HEADER
# (the old horizontal "Menu / Liste des rapports / ..." tab
# row was removed here — the sidebar already owns top-level
# navigation, so that row was redundant.)
# --------------------------------------------------------
